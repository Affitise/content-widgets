...
Affitise.feed = function(apiKey, feedId) {
    ...
    this.getLogoDiv = function() {
        var logo = '<a href="https://affitise.com?utm_source=content-widget&utm_medium=' + this.size + '&utm_campaign=' + this.feedId + '" target="_blank"><img src="' + this.cdnBaseUrl + '/affilogo.png" /> Affitise</a>';
